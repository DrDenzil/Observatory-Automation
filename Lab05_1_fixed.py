...
class MyTopo( Topo ):  
    def __init__( self ):
        ...
        Switch1 = self.addSwitch( 'Switch1', stp=True, failMode='standalone')
        Switch2 = self.addSwitch( 'Switch2', stp=True, failMode='standalone')
        Switch3 = self.addSwitch( 'Switch3', stp=True, failMode='standalone')
        Switch4 = self.addSwitch( 'Switch4', stp=True, failMode='standalone')
