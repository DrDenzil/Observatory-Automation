...
//check if RTML belongs to user? or doesn't it matter?
...
$rtmlid=$_GET['id'];
    ...
    $file_path = "rtml/json/".$rtmlid.".json";
...
/*
		...
		if(copy($file_path, "rtml/editor/".$userid.".json")){
			echo"The RTML file was successfully reloaded.<br>
			Continue to the <a href=\"rtmleditor.php\">Plan Generator</a> to make any changes.";
		}else{
			echo"Unfortunately this plan couldn't be reloaded";
		}
